...
基本的には可動部分を動かした時、ネジとナットが動かない状態であれば緩むことはありません。<br>
...
* <b>ナットを使う場合はナットを固定して動かなくなる構造にしておく。</b><br>
...
テクニックとしてクレオスの水性ラッカー「アクリジョン」のクリアをボール穴に筆で厚めに塗って乾いたらリューターで削ると良い具合になります。<br>
